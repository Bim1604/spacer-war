...
class PauseMenu extends StatelessWidget {
  static const String ID = "PauseMenu.ID";
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                }, child: const Text('Resume', style: TextStyle(fontFamily: 'Game', fontSize: 24))
              ),
            ),
            SizedBox(
              width: size.width / 3,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: (){
                  bool remove = gameRef.overlays.remove(PauseMenu.ID);
                  if (remove) {
